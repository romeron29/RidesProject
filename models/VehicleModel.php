...
class VehicleModel {
    ...
    public function delete_vehicle($id_vehiculo) { //Revisar cascade en la base de datos
        try {
            $stmt = $this->db_conn->prepare("DELETE FROM vehiculos WHERE id_vehiculo = :id_vehiculo");
