    ...
    <div class="form-container">
        <form class="form" action="index.php?action=auth" method="post">
            ...
            <div class="field">
                ...
                <input autocomplete="off" name="correo" placeholder="Correo electrónico" class="input-field" type="email" required>
            </div>
            ...
            <div class="field">
                ...
                <input placeholder="Contraseña" name="contrasenna" class="input-field" type="password" required>
            </div>
